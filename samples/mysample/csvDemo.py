...
def turtle_test(dataString='pyalg'):
    ...
    """
    feed = yahoofeed.Feed()
    feed.addBarsFromCSV("orcl", "D:/Develop/project/python/PycharmProjects/python3/pyalgotrade/api/stock/csv/orcl-2000.csv")   #注意查看该csv的格式，Open为大写
...
if __name__ == '__main__':
    turtle_test()
    # turtle_test(dataString='pyalg_util')