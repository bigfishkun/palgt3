...
if __name__ == '__main__':
    dc = DailyCrawler()
    #dc.crawl_index('2008-01-01', '2018-12-31')
    # dc.crawl('2008-01-01', '2010-12-31')
    # dc.crawl('2011-01-01', '2013-12-31')
    # dc.crawl('2014-01-01', '2016-12-31')
    dc.crawl('2017-01-01', '2018-12-31')